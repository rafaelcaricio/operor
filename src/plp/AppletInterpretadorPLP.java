...
public class AppletInterpretadorPLP extends Applet {
	...
	private Panel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabelExecutar.setMinimumSize(new Dimension(300, 17));
			jLabelExecutar.setBounds(new java.awt.Rectangle(19, 434, 300, 17));
			jLabelExecutar.setText("Pressione Ctrl+E para executar");
	...
	private JComboBox getJComboBoxLinguagens() {
		if (jComboBoxLinguagens == null) {
			...
			jComboBoxLinguagens.addItem("Expressoes 1"); //0
			jComboBoxLinguagens.addItem("Expressoes 2"); //1
			jComboBoxLinguagens.addItem("Funcional 1");  //2
			jComboBoxLinguagens.addItem("Funcional 2");  //3
			jComboBoxLinguagens.addItem("Funcional 3");  //4
			jComboBoxLinguagens.addItem("Imperativa 1"); //5
			jComboBoxLinguagens.addItem("Imperativa 2"); //6
			jComboBoxLinguagens.addItem("Orientada a Objetos 1"); //7
			jComboBoxLinguagens.addItem("OperOR"); //8
			jComboBoxLinguagens.setSelectedIndex(8);
