...
import plp.operor.util.TipoFuncao;
...
public class Aplicacao implements Expressao {
	...
	public Valor avaliar(AmbienteExecucao ambiente)
		...
		Expressao exp = funcao.getExp();
		
		AmbienteExecucaoOperacional ambOperacional = (AmbienteExecucaoOperacional) ambiente;
		for (DecOperador dOp : funcao.getOpCriadores()) {
			ambOperacional.mapOperador(dOp.getListaOperadores().getDefinicaoGenerica(), dOp, false);
		}
