...
/**
 * Uma definiçao de classe é uma declaraçao de variável e
 * uma declaração de procedimento. Ambos podem ser simples ou compostos.
 */
public class DefClasse {
    ...
    /**
     * Construtor
     * @param decVariavel Declaração de Variáveis
     * @param decProcedimento Declaraçao dos Procedimentos.
     */
     ...
     * @param idMetodo Identificador do método
    ...
    /**
     * O método abaixo deve verificar se existe algum atributo, identificado por idAtributo
