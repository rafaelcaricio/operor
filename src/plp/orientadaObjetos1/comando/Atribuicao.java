...
public class Atribuicao implements Comando {
    ...
    public AmbienteExecucaoOO1 executar(AmbienteExecucaoOO1 ambiente)
        ...
        if ( av instanceof AcessoAtributo){
            ...
            AmbienteExecucaoOO1 aux = obj.getEstado();                   // recuperando o ambiente do objeto
            aux.changeValor(idVariavel, expressao.avaliar(ambiente)); // alterando o ambiente do objeto
        }
        else
