...
public class DecVariavelObjeto implements DecVariavel{
    ...
    /**
     * Construtor.
     * @param tipo Tipo declarado da variável.
     * @param objeto Identificador do objeto.
     * @param classe Classe da qual objeto é uma instância.
     */
    ...
    public AmbienteExecucaoOO1 elabora(AmbienteExecucaoOO1 ambiente)
        ...
        AmbienteExecucaoOO1 aux =  new SimplesDecVariavel(tipo, objeto, new ValorNull()).elabora(ambiente);
     ...
     * @param ambiente o ambiente que contem o mapeamento entre objetos
     *  e suas classes.
     * @return <code>true</code> a classe existe
