...
public class CompostaDecVariavel implements DecVariavel{
    ...
    /**
     * Construtor.
     * @param parametro1 Primeira declaraçao de variável.
     * @param parametro2 Restante da declaração de variáveis.
     */
     ...
     * @param id O identificador da variável.
     * @return o tipo deste identificador nessa declaraçao.
     * @throws VariavelNaoDeclaradaException Quando nao há nenhuma variável
     * declarada com esse id na declaração.
     */
    ...
    /**
     * Cria um mapeamento dos identificadores para os valores das
     * expressões desta declaração composta no AmbienteExecucao
    ...
    /**
     * Verifica se as declarações estão bem tipadas, ou seja, se as
     * expressões de inicialização estão bem tipadas.
     * @param ambiente o ambiente que contem o mapeamento entre identificadores
     *  e seus tipos.
