...
import plp.operor.Programa;

@RunWith(Parameterized.class)
public class ProgramasAceitosTest {

	static OperORParser parser;
	String input;
	...
	@Before
	public void setup() {
		OperORParser.disable_tracing();
		ByteArrayInputStream bis = new ByteArrayInputStream(input.getBytes());
		if (parser == null)
			parser = new OperORParser(bis);
		else
			OperORParser.ReInit(bis);
	...
	public void testInput() throws ParseException {
		...
		Programa programa = OperORParser.Input();
